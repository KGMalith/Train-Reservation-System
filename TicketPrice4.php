...
<body>
    ...
    <div id="back">
        <div id="toDiv">
            <!--Table Topic-->
            <h2 class="topic"><b><u>Ticket Prices</u></b></h2>
            <p class="classN"><b>(1st Class A/C)</b></p>
            <p>(All are in "Srilanka Rupees")</p>
        </div>
        ...
        <br/>
        <div>
            <p class="Nlist"><u><b>Name List</b></u></p>
            <table class="table2">
                <!--Name Table-->
                <tr>
                    <th>Short Name</th>
        ...
        <div class="pagination">
            <a href="TicketPrice3.php">&laquo;</a>
            <a href="TicketPrice.php">1</a>
            <a href="TicketPrice2.php">2</a>
            <a href="TicketPrice3.php">3</a>
            <a href="TicketPrice4.php" class="active">4</a>
            <a href="TicketPrice4.php">&raquo;</a>
        </div>
