...
<body>
    ...
    <div id="box8">
        ...
        <form name="addTrain" action="Server/AddNewStationServer.php" target="blank" method="POST" class="FIM">

            <label>Station Name </label><br>
            <input type="text" name="sname" placeholder="Enter Train Station Name" id="trainName" ></br><br>

            <button type="submit"  id="sub7" name="addstations">Add </button>
